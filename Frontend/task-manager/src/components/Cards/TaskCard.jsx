...
const TaskCard = ({
  ...
  return (
    <div
      className="bg-white rounded py-4 shadow-md shadow-gray-100 border border-gray-200/50 cursor-pointer"
      onClick={onClick}
    >
      <div className="flex items-end gap-3 px-4">
        ...
        {/* Priority tag moved inside the same flex container for proper alignment */}
        <div
      ...
      <div className="px-4 mt-4"> {/* Added margin-top for spacing */}
